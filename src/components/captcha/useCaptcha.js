    ...
    <div style={{display: "flex",alignItems: "center",justifyContent: "center"}}>
      ...
      <div className="captcha_wrap">
        ...
        <div className="captcha_slider">
          ...
          <div className="captcha_slider_button" ref={dragHeadRef} style={{transform: `translate(${Math.min(Math.max(position, 0), 228)}px, 0px)`, transition:isDragging.current?'none':'all 0.5s'}}>{isDragging.current?/*<Icon.Arrows color={'#fff'}/>*/'sds':'kjk'/*<Icon.TouchFinger color={'#fff'}/>*/}</div>
        </div>
